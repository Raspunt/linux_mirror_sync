package io.github.jazzysync.cli;
...
import io.github.jazzysync.mirror.core.MirrorFactory;
import io.github.jazzysync.mirror.api.MirrorStatus;
    ...
    public Integer call() {
        ...
        if ("all".equalsIgnoreCase(effectiveTarget)) {
            ...
            try {
                ...
                System.err.println("Run 'jazzy list' to see available distributions.");
                return 1;
            }
        }
